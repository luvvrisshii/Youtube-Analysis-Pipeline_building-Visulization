...
part_eff_df = ApplyMapping_node2.toDF().coalesce(1)
final_df = DynamicFrame.fromDF(part_eff_df, glueContext, "final_df")
...
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="glueparquet",
    connection_options={
        "path": "s3://youtube-analysis-clean-de-dev/youtube/clean-sets/",
